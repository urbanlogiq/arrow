        ...
        match sql {
            ...
            SQLExpr::BinaryOp {
                ...
                let operator = match *op {
                    ...
                    BinaryOperator::Contains => Ok(Operator::Contains),
            ...
            SQLExpr::Function(function) => {
                ...
                // Special case: map NULLIF to binary expression.
                // TODO: move NULLIF into BuiltInScalarFunction.
                if name.to_uppercase() == "nullif" {
                    ...
                    if rex_args.len() != 2 {
                        return Err(ExecutionError::General("NULLIF needs two args (expr, expr)".to_string()))
                    } else {
